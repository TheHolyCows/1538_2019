...
AutoModes::AutoModes()
{
	...
	m_Modes["Two Hatch Rocket - Right"].push_back(RobotCommand(CMD_PRESTART, 0, 0, 0, 0, true, 0.375));
	m_Modes["Two Hatch Rocket - Right"].push_back(RobotCommand(CMD_VISION_HATCH_INTAKE, 0, 0, 0, 0, true, 0.25));
	...
	m_Modes["One Hatch Rocket - Left"].push_back(RobotCommand(CMD_PRESTART, 0, 0, 0, 0, true, 0.375));
	m_Modes["One Hatch Rocket - Left"].push_back(RobotCommand(CMD_VISION_HATCH_INTAKE, 0, 0, 0, 0, true, 0.25));
	...
	m_Modes["Two Hatch Rocket - Left"].push_back(RobotCommand(CMD_PRESTART, 0, 0, 0, 0, true, 0.375));
